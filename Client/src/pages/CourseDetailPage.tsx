...
export default function CourseDetailPage() {
  ...
  const { data: enrollmentStatus, isLoading: isEnrollmentLoading } =
    useEnrollmentStatus(id);

  const { mutateAsync: enroll, isPending: isEnrollLoading } =
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            <div className="lg:col-span-8">
              <div className="flex flex-wrap gap-2 mb-4">
                <Badge
                  variant="secondary"
                  className="bg-indigo-50 text-indigo-600 border-none px-3 py-1"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-slate-800">
                      {course.instructor || "Đội ngũ WebHocTap"}
                    </span>
                  </div>
                </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-lg font-bold text-blue-900 mb-1">
                            Đang có lớp học Live!
                          </h3>
                          <p className="text-blue-700 text-sm">
                            Giảng viên đang livestream phân tích nội dung chuyên
                            sâu. Hãy tham gia ngay để không bỏ lỡ.
                          </p>
                  ...
                  <div className="space-y-4">
                    ...
                    {!isLessonsLoading && lessons.length === 0 && (
                      <div className="text-center p-12 bg-white rounded-2xl border border-dashed border-slate-200">
                        ...
                        <p className="text-slate-500 font-medium">
                          Hiện tại chưa có bài học nào cho khóa này.
                        </p>
                      </div>
                    )}
                  </div>
