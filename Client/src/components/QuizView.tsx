      ...
      try {
        ...
        if (isMounted) {
          if (
            ...
            attemptData.status === "MAX_ATTEMPTS_REACHED"
          ) {
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:px-6 lg:px-8 bg-slate-50">
        {result ? (
          <div className="max-w-3xl mx-auto mt-6 bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100 text-center">
            <CheckCircle
              className={`w-16 h-16 mx-auto mb-4 ${result.passed ? "text-green-500" : "text-red-500"}`}
            />
            ...
            <div className="mt-8 flex justify-center">
              <Button
                onClick={() =>
                  quiz?.courseId && navigate(`/courses/${quiz.courseId}`)
                }
